Shader "CelShading/Lighting Ramp"
{
    Properties
    {
        ...
        _Color1 ("Color for Black", Color) = (0,0,0,1) // Color replacing black
        _Color2 ("Color for White", Color) = (1,1,1,1) // Color replacing white
    }
    ...
    SubShader
    {
        ...
        float _Glossiness;
        float _Fresnel;
        fixed4 _Color1; // First color for black
        fixed4 _Color2; // Second color for white
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
            ...
            float intensity = dot(texColor.rgb, float3(0.3, 0.59, 0.11)); // Convert to grayscale intensity
            o.Albedo = lerp(_Color1.rgb, _Color2.rgb, intensity); // Blend between _Color1 and _Color2 based on intensity
